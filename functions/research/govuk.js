...
function fmtAcademicResultsSlim(perf, phase, fallbackNor = null, laPerf = null, tablesOnly = false) {
  ...
  const KS4_TOPICS = [
    { heading: "Attainment 8", cols: "all", rows: [
      ...
      { label: "Disadvantaged", var: "ATT8SCR_FSM6CLA1A" },
      { label: "Not disadvantaged", var: "ATT8SCR_NFSM6CLA1A" },
      { label: "EAL", var: "ATT8SCR_EAL" },
      { label: "Boys", var: "ATT8SCR_BOYS" },
      { label: "Girls", var: "ATT8SCR_GIRLS" },
      { label: "Non-mobile", var: "ATT8SCR_NMOB" },
      { label: "2024", var: "ATT8SCR_PREV" },
      { label: "2023", var: "ATT8SCR_PREV2" },
    ]},
    { heading: "Progress 8", cols: "all", rows: [
      { label: "Progress 8 score", var: "P8MEA" },
      { label: "Lower CI", var: "P8LOWER" },
      { label: "Upper CI", var: "P8UPPER" },
      { label: "Disadvantaged", var: "P8MEA_FSM6CLA1A" },
      { label: "2024", var: "P8MEA_PREV" },
      { label: "2023", var: "P8MEA_PREV2" },
    ]},
    { heading: "Grade 5+ English & Maths", cols: "all", rows: [
      { label: "All pupils", var: "PTL2BASICS_95" },
      { label: "Boys", var: "PBL2BASICS_95" },
      { label: "Girls", var: "PGL2BASICS_95" },
      { label: "Disadvantaged", var: "PTFSM6CLA1ABASICS_95" },
      { label: "Not disadvantaged", var: "PTNOTFSM6CLA1ABASICS_95" },
      { label: "EAL", var: "PTL2BASICSEAL_95" },
      { label: "Non-mobile", var: "PTL2BASICSNMOB_95" },
      { label: "2024", var: "PTL2BASICS_95_PREV" },
      { label: "2023", var: "PTL2BASICS_95_PREV2" },
    ]},
    { heading: "Grade 4+ English & Maths", cols: "all", rows: [
      { label: "All pupils", var: "PTL2BASICS_94" },
      { label: "Boys", var: "PBL2BASICS_94" },
      { label: "Girls", var: "PGL2BASICS_94" },
      { label: "Disadvantaged", var: "PTFSM6CLA1ABASICS_94" },
      { label: "Not disadvantaged", var: "PTNOTFSM6CLA1ABASICS_94" },
      { label: "EAL", var: "PTL2BASICSEAL_94" },
      { label: "2024", var: "PTL2BASICS_94_PREV" },
      { label: "2023", var: "PTL2BASICS_94_PREV2" },
    ]},
    { heading: "EBacc entry", cols: "all", rows: [
      { label: "% entering EBacc", var: "PTEBACC_E_PTQ_EE" },
      { label: "Boys", var: "PBEBACC_E_PTQ_EE" },
      { label: "Girls", var: "PGEBACC_E_PTQ_EE" },
      { label: "Disadvantaged", var: "PTEBACC_EFSM6CLA1A_PTQ_EE" },
      { label: "Not disadvantaged", var: "PTEBACC_ENFSM6CLA1A_PTQ_EE" },
      { label: "EAL", var: "PTEBACC_EEAL_PTQ_EE" },
      { label: "Non-mobile", var: "PTEBACC_ENMOB_PTQ_EE" },
      { label: "2024", var: "PTEBACC_E_PTQ_EE_PREV" },
      { label: "2023", var: "PTEBACC_E_PTQ_EE_PREV2" },
    ]},
    { heading: "EBacc entry by subject", cols: "all", rows: [
    ...
    { heading: "EBacc achievement", cols: "all", rows: [
      { label: "% EBacc 5+", var: "PTEBACC_95" },
      { label: "% EBacc 4+", var: "PTEBACC_94" },
      { label: "EBacc APS", var: "EBACCAPS" },
      { label: "% EBacc 5+ (boys)", var: "PBEBACC_95" },
      { label: "% EBacc 4+ (boys)", var: "PBEBACC_94" },
      { label: "% EBacc 5+ (girls)", var: "PGEBACC_95" },
      { label: "% EBacc 4+ (girls)", var: "PGEBACC_94" },
      { label: "Disadv. 5+", var: "PTEBACC_95_FSM6CLA1A" },
      { label: "Disadv. 4+", var: "PTEBACC_94_FSM6CLA1A" },
      { label: "Not disadv. 5+", var: "PTEBACC_95_NFSM6CLA1A" },
      { label: "Not disadv. 4+", var: "PTEBACC_94_NFSM6CLA1A" },
      { label: "EAL 5+", var: "PTEBACCEAL_95" },
      { label: "EAL 4+", var: "PTEBACCEAL_94" },
      { label: "Non-mobile 5+", var: "PTEBACCNMOB_95" },
      { label: "Non-mobile 4+", var: "PTEBACCNMOB_94" },
      { label: "EBacc APS (boys)", var: "EBACCAPS_BOYS" },
      { label: "EBacc APS (girls)", var: "EBACCAPS_GIRLS" },
      { label: "EBacc APS (disadv.)", var: "EBACCAPS_FSM6CLA1A" },
      { label: "EBacc APS (EAL)", var: "EBACCAPS_EAL" },
      { label: "2024 EBacc 5+", var: "PTEBACC_95_PREV" },
      { label: "2024 EBacc 4+", var: "PTEBACC_94_PREV" },
      { label: "2023 EBacc 5+", var: "PTEBACC_95_PREV2" },
      { label: "2023 EBacc 4+", var: "PTEBACC_94_PREV2" },
      { label: "2024 EBacc APS", var: "EBACCAPS_PREV" },
      { label: "2023 EBacc APS", var: "EBACCAPS_PREV2" },
    ]},
    { heading: "EBacc subject achievement (9-4)", cols: "all", rows: [
      { label: "English", var: "PTEBACENG_94" },
      { label: "Maths", var: "PTEBACMAT_94" },
      { label: "Science", var: "PTEBAC2SCI_94" },
      { label: "Humanities", var: "PTEBACHUM_94" },
      { label: "Languages", var: "PTEBACLAN_94" },
    ]},
    { heading: "EBacc subject achievement (9-5)", cols: "all", rows: [
      { label: "English", var: "PTEBACENG_95" },
      { label: "Maths", var: "PTEBACMAT_95" },
      { label: "Science", var: "PTEBAC2SCI_95" },
      { label: "Humanities", var: "PTEBACHUM_95" },
      { label: "Languages", var: "PTEBACLAN_95" },
    ]},
    { heading: "Cohort characteristics", cols: "all", rows: [
      { label: "Pupils at end of KS4", var: "TPUP" },
      { label: "Boys at end of KS4", var: "BPUP" },
      { label: "Girls at end of KS4", var: "GPUP" },
    ...
    { heading: "Entry volumes", cols: "all", rows: [
...
export function computeFlags(school) {
  ...
  if (!isNaN(att8) || !isNaN(p8) || !isNaN(rwm)) {
    if ((!isNaN(att8) && att8 > nat4.ATT8SCR + 10) ||
      ...
      flags['A5. Academic Performance'] = 'green';
    } else if ((!isNaN(att8) && att8 < nat4.ATT8SCR - 10) ||
               (!isNaN(p8)   && p8 < -0.5) ||
               (!isNaN(rwm)  && rwm < nat2.PTRWM_EXP - 10)) {
      flags['A5. Academic Performance'] = 'red';
    }
  } else {
    // KS5-only schools — use VA band
    const ks5Band = parseInt(vv('PROGRESS_BAND_ALEV') ?? '', 10);
    if (ks5Band === 1)    flags['A5. Academic Performance'] = 'green';
    else if (ks5Band >= 4) flags['A5. Academic Performance'] = 'red';
  }
  ...
  if (!isNaN(absVal) || !isNaN(persVal)) {
    if ((!isNaN(absVal) && absVal < 5) || (!isNaN(persVal) && persVal < 15))
      flags['A6. Absence'] = 'green';
    else if ((!isNaN(absVal) && absVal > 8.6) || (!isNaN(persVal) && persVal > 23.3))
      flags['A6. Absence'] = 'red';
  }

  // A7 — financial: red if in-year deficit or QTS below comparator
  if (financial) {
    ...
    if (isDeficit || (!isNaN(qts) && !isNaN(cmpQts) && qts < cmpQts))
      flags['A7. Financial Position and Staffing'] = 'red';
  }

  // A8 — area: red if IMD 1–3 or mean household income below £35,000
  if (area) {
...
export function renderPartA(school, flags = {}) {
  ...
  // ────────────────────────────────────────────────────────────────────────────
  {
    ...
    sections.push({ heading: 'A3. What the School Needs to Improve', body, flag: flags['A3. What the School Needs to Improve'] ?? 'none' });
  }

  // ────────────────────────────────────────────────────────────────────────────
  // A4. Pupil Census  (was A5)
  // ────────────────────────────────────────────────────────────────────────────
  {
    const nor  = v('NOR');
  ...
  // ────────────────────────────────────────────────────────────────────────────
  // A5. Academic Performance  (was A6)
  // ────────────────────────────────────────────────────────────────────────────
  {
  ...
  // ────────────────────────────────────────────────────────────────────────────
  {
    ...
    sections.push({ heading: 'A6. Absence', body: lines.join('\n'), flag: flags['A6. Absence'] ?? 'none' });
  }

  // ────────────────────────────────────────────────────────────────────────────
  // A7. Financial Position and Staffing  (was A8)
  // ────────────────────────────────────────────────────────────────────────────
  {
    let body;
    ...
    sections.push({ heading: 'A7. Financial Position and Staffing', body, flag: flags['A7. Financial Position and Staffing'] ?? 'none' });
  }

  // ────────────────────────────────────────────────────────────────────────────
  // A8. Area Profile  (was A9)
  // ────────────────────────────────────────────────────────────────────────────
  {
    let body;
    if (!area) {
