...
export function renderPartA(school, flags = {}) {
  ...
  // The full narrative is provided to the AI model in the slim block; the AI
  // generates a concise summary that replaces this placeholder via interleaveVerdicts.
  // ────────────────────────────────────────────────────────────────────────────
  let _pupilExperienceBody;
  {
    if (isIndependent) {
      _pupilExperienceBody = 'Independent school — see ISI inspection report for pupil experience. The AI model will summarise the findings below.';
    } else if (ofsted?.pupilExperience) {
      _pupilExperienceBody = `_The pupil experience summary for this school is generated by the AI based on the Ofsted inspection report._`;
    } else {
